...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>Ver detalles de la cuenta</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>Ver perfil en Twitter</a></li></ul>'),
    modal_header: Hogan.compile('<h3>Detalles de la cuenta <span class="download-date muted">como de {{created_at_relative}}</span></h3>'),
    ...
    modal_account_details: Hogan.compile('<p><span class="footer-label muted">ID de usuario</span> #{{id}}</p><p class="truncated"><span class="footer-label muted">Registrado</span> {{created_at_relative}}</p>'),
...
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', 'Tu consulta debe tener al menos dos caracteres.')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', 'Buscar todos los Tweets');
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      document.title = "Tu archivo de Twitter ";
      $('#footer-text').append("Este es un archivo fuera de línea de tus Tweets de Twitter. Usa los meses de arriba para navegar por el archivo.");
      var compose_new_tweet = "Publicar un nuevo Tweet";
